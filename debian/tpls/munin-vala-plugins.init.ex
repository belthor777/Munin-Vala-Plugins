...
NAME="munin-vala-plugins"           		# Introduce the short server's name here
DAEMON=/usr/bin/munin-vala-plugins     		# Introduce the server's location here
DAEMON_ARGS="-b -d0 -r2"     		# Arguments to run the daemon with
